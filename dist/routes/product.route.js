...
import { createProductValidation, getProductByIdValidation, } from "../middleware/product.validation.js";
 ...
 *         description: Produk tidak ditemukan
 */
router.put("/:id", authenticate, upload.single("image"), validate(createProductValidation), controller.update);
/**
 * @swagger
 * /products/{id}:
 *   delete:
