...
import { createProfileValidation, updateProfileValidation, getProfileValidation, getUserProfileValidation, } from "../middleware/profile.validation.js";
 ...
 */
router.post("/", authenticate, upload.single("image"), validate(createProfileValidation), controller.create);
/**
 * @swagger
 * /profiles:
 *   get:
 ...
 *         description: Profil tidak ditemukan
 */
router.get("/user/:userId", validate(getUserProfileValidation), controller.getByUserId);
/**
 * @swagger
 * /profiles/{id}:
 *   get:
 ...
 *         description: Profil tidak ditemukan
 */
router.put("/:id", authenticate, validate(updateProfileValidation), controller.update);
/**
 * @swagger
 * /profiles/{id}:
 *   delete:
